...
Setup
-----
After completing windows setup then run vaultress-qt.
Alternatively you can run windows command line (cmd) in vaultress program dir.
  cd daemon
  vaultressd
You would need to create a configuration file vaultress.conf in the default
wallet directory. Grant access to vaultressd/vaultress-qt in anti-virus and firewall
