...
UNIX BUILD NOTES FOR VAULTRESS
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/vaultress/vaultress
	cd vaultress
	git checkout v0.6.3acu
...
This will build Vaultress-Qt as well if the dependencies are met.
...
Note: Currently, there is no vaultress ebuild available in overlay 
...
Take the following steps to build (no UPnP support):
	...
	strip src/vaultressd


Notes
-----
The release is built with GCC and then "strip vaultressd" to strip the debug
