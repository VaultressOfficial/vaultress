 ...
 * vaultress public-key-hash-addresses have version 55 (or 111 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 70,  // coin: addresses begin with 'V'
        SCRIPT_ADDRESS = 132, // coin: addresses begin with 'v'
