...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Vaultress " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
	{"seed0", "seed0.u6t7c6.com"},
    {"seed1", "seed1.u6t7c6.com"},
    {"seed2", "seed2.u6t7c6.com"},
    {"seed3", "seed3.u6t7c6.com"},
    {"seed4", "seed4.u6t7c6.com"},
    {"seed5", "seed5.u6t7c6.com"},
    {"seed6", "seed6.u6t7c6.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Vaultress is probably already running."), addrBind.ToString().c_str());
        else
