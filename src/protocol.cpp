...
static unsigned char pchMessageStartTestNew[4] = { 0xd0, 0xa4, 0xec, 0xcc };
static unsigned int nMessageStartTestSwitchTime = 1346200000;

// Vaultress message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf9, 0xbe, 0xb4, 0xd9 };
static unsigned char pchMessageStartVaultress[4] = { 0x73, 0x3b, 0x39, 0xb8 };
static unsigned int nMessageStartSwitchTime = 1347300000;

unsigned char pchMessageStart[4] = { 0x74, 0x3c, 0x3a, 0xb9 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartVaultress : pchMessageStartBitcoin, sizeof(pchMessageStartVaultress));
}
