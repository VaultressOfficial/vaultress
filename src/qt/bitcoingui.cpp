 ...
 * The Vaultress developers 2011-2018
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Vaultress") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/vaultress"));
    setWindowIcon(QIcon(":icons/vaultress"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Vaultress address"));
	...
	blockBrowserAction = new QAction(QIcon(":/icons/bex"), tr("Block Explorer"), this);
    blockBrowserAction->setStatusTip(tr("Explore the blockchain and transactions"));
    blockBrowserAction->setToolTip(blockBrowserAction->statusTip());
    ...
    aboutAction = new QAction(QIcon(":/icons/vaultress"), tr("&About Vaultress"), this);
    aboutAction->setStatusTip(tr("Show information about Vaultress"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Vaultress"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/vaultress"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Vaultress addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Vaultress addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/vaultress"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://vaultress.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/vaultress"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.vaultress.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/vaultress_testnet"));
            setWindowIcon(QIcon(":icons/vaultress_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/vaultress_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Vaultress client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://vaultress.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.vaultress.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vaultress network", "", count));
}
...
{
    QString strTitle = tr("Vaultress"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Vaultress address or malformed URI parameters."),
